...
fn tint_symbol_99_inner(tint_symbol_95_3 : vec3u) {
  ...
  if (x_1721) {
    let x_1732 = ((x_1663 * tan(tint_symbol_75.inner.tint_symbol_65.xy)) / tint_symbol_75.inner.tint_symbol_66.xy);
    tint_symbol_37_2 = vec3f();
    tint_symbol_98_1 = normalize(vec3f((((f32(x_1708.x) + 0.5f) * x_1732.x) - ((tint_symbol_75.inner.tint_symbol_66.x * x_1732.x) / 2.0f)), (((f32(x_1708.y) + 0.5f) * x_1732.y) - ((tint_symbol_75.inner.tint_symbol_66.y * x_1732.y) / 2.0f)), 1.0f));
    let x_1761 = tint_symbol_37_2;
    let x_1760 = tint_symbol_84(x_1761);
    tint_symbol_37_2 = x_1760;
    let x_1763 = tint_symbol_98_1;
    let x_1762 = tint_symbol_82(x_1763);
    tint_symbol_98_1 = x_1762;
    let x_1765 = tint_symbol_37_2;
    let x_1766 = tint_symbol_98_1;
    let x_1764 = tint_symbol_86(x_1765, x_1766);
    tint_symbol_58_3 = x_1764;
    let x_1770 = tint_symbol_58_3.x;
    let x_1773 = tint_symbol_58_3.y;
    let x_1771 = tint_ftoi(x_1773);
    tint_symbol_91(x_1708, x_1770, x_1771);
  }
  return;
}

fn tint_symbol_99_1() {
  let x_1777 = tint_symbol_95_2;
  tint_symbol_99_inner(x_1777);
  return;
}
