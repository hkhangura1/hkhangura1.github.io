...
fn tint_symbol_25_inner(tint_symbol_26 : vec3u) {
  ...
  if ((x_158 < arrayLength(&(tint_symbol_12.inner)))) {
    ...
    tint_symbol_11.inner[x_169].tint_symbol_3 = (tint_symbol_11.inner[x_169].tint_symbol_3 + ((x_193 * x_192) / vec2f((tint_symbol_10.inner[x_169].tint_symbol_4 * 1000.0f))));
...
fn tint_symbol_38_inner(tint_symbol_26_3 : vec3u) {
  ...
  var x_220 : u32;
  x_220 = tint_symbol_26_3.x;
  if ((tint_symbol_10.inner[x_220].tint_symbol_5 != 1.0f)) {
    if ((x_220 < arrayLength(&(tint_symbol_10.inner)))) {
      tint_symbol_16 = tint_symbol_10.inner[x_220];
      tint_symbol_11.inner[x_220].tint_symbol_1 = ((tint_symbol_16.tint_symbol_1 + tint_symbol_16.tint_symbol_2) + tint_symbol_11.inner[x_220].tint_symbol_3);
      tint_symbol_11.inner[x_220].tint_symbol_2 = ((tint_symbol_16.tint_symbol_2 + tint_symbol_11.inner[x_220].tint_symbol_3) * 0.94999998807907104492f);
      tint_symbol_11.inner[x_220].tint_symbol_3 = vec2f();
      tint_symbol_11.inner[x_220].tint_symbol_4 = tint_symbol_16.tint_symbol_4;
    }
  }
  return;
}
...
fn tint_symbol_38_1() {
  let x_260 = tint_symbol_26_2;
  tint_symbol_38_inner(x_260);
  return;
}
